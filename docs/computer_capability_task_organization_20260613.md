...
- Stop/go decision: Step 11 durable 10-day calibration-artifact rerun is complete and GO for reliability-bin inspection plus a controlled decision on whether isotonic/Platt/post-hoc calibration is required. Still NO paper/live promotion until post-hoc calibration/frozen-holdout threshold-stability gates, recorded-event replay parity, and paper/shadow drift checks pass.
