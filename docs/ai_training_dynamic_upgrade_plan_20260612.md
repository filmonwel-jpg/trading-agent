...
- Recommended next blocker: complete the remaining Step 10 recorded-event replay artifact by capturing a real market-hours live-shaped NDJSON sample, replaying it through `DatabentoHistoricalStreamingBacktester`, and comparing bucket boundaries, quality fields, feature vectors, model scores, and decisions; in parallel or immediately after, continue probability-calibration/manifest hardening. Do not start paper/live promotion work from the 10-day smoke metrics or this first-pass parity wiring alone.
