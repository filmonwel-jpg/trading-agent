...
SETUP_PREDICTIONS=$SETUP_PREDICTIONS
RUN_STAGE_INPUTS=$RUN_STAGE_INPUTS
RUN_SETUP_STAGE=$RUN_SETUP_STAGE
RUN_LIFECYCLE_STAGE=$RUN_LIFECYCLE_STAGE
RUNNER_PREFLIGHT_ONLY=$RUNNER_PREFLIGHT_ONLY
...
LIFECYCLE_MAX_ENTRY_EVENTS=$LIFECYCLE_MAX_ENTRY_EVENTS
LIFECYCLE_MAX_ENTRY_EVENTS_PER_SYMBOL_SIDE=$LIFECYCLE_MAX_ENTRY_EVENTS_PER_SYMBOL_SIDE
LIFECYCLE_MAX_STAGED_ROWS_PER_SYMBOL_PER_MODEL=$LIFECYCLE_MAX_STAGED_ROWS_PER_SYMBOL_PER_MODEL
LIFECYCLE_MAX_TRAIN_ROWS_PER_MODEL=$LIFECYCLE_MAX_TRAIN_ROWS_PER_MODEL
EOF
